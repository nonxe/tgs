...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Secure file link sharing and anonymous note publisher in a premium iOS-themed interface." },
      { name: "author", content: "CLOUD" },
      { property: "og:title", content: "CLOUD • Link & Notes" },
      { property: "og:description", content: "Secure file link sharing and anonymous note publisher in a premium iOS-themed interface." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@CLOUD" },
      { name: "twitter:title", content: "CLOUD • Link & Notes" },
      { name: "twitter:description", content: "Secure file link sharing and anonymous note publisher in a premium iOS-themed interface." },
